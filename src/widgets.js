...
PushButtonMorph.prototype.pressColor = new Color(106, 28, 232);
// PushButtonMorph.prototype.pressColor = new Color(237, 108, 9);
...
DialogBoxMorph.prototype.promptYesNo = function (
    title,
    textString,
    world,
    pic,
    ...
    this.addButton(function() {
        yesCallback(this, caller);
    }, 'Yes');
    this.addButton(function() {
        noCallback(this, caller);
    }, 'No');
    this.fixLayout();
    this.popUp(world);
};
DialogBoxMorph.prototype.promptYesNoWithCustomButtons = function (
    title,
    textString,
    world,
    pic,
...
DialogBoxMorph.prototype.blockPrompt = function (
    title,
    defaultString,
    world,
    pic,
    ...
    txt.fixLayout();
    this.addButton(function() {
        okCallback(this, caller, inp);
    }, 'OK');
    this.addButton(function() {
        cancelCallback(this, caller);
    }, 'Cancel');
    this.fixLayout();
    this.popUp(world);
};
