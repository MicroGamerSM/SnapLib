...
IDE_Morph.prototype.setFlatDesign = function () {
    ...
    // IDE_Morph.prototype.buttonContrast = 30;
    // IDE_Morph.prototype.backgroundColor = new Color(10, 10, 10);
    // IDE_Morph.prototype.frameColor = new Color(10, 10, 10);
...
IDE_Morph.prototype.createCategories = function () {
    ...
    function addCategoryButton(category) {
        var modCats = ['mod', 'popups', 'blocks', 'debugging'];
        ...
        button = new ToggleButtonMorph(
            ...
            null, // env
            modCats.includes(category) ? 'mod category' : 'block category: used to\nprovide coloring to blocks\nas well as categorization', // hint
            labelWidth, // minWidth
            true // has preview
        );
    ...
    function addCustomCategoryButton(category, color) {
        ...
        button = new ToggleButtonMorph(
            ...
            categoryQueryAction(category), // query
            null, // env
            'custom block category: fill it with your own blocks', // hint
            labelWidth, // minWidth
            true // has preview
        );
...
IDE_Morph.prototype.createNewCategory = function () {
    new DialogBoxMorph(
        ...
        null,
        new Color(106, 28, 232),
        this.world(),
        null, // pic
        'new category name' // msg
    );
};
